     ...
     <div className="Login-page">
       ...
       <NavLink to="/Introcarousel">  <img src="/BlackPrimeLogo.png" alt="Prime Logo" className="Login-logo" /> </NavLink>  
                <div className="Login-form">
                    ...
                    <input type="email" name="user-email" className='Login-email'/>
                    <button className="Login-button Login-button--continue"> Continuar </button>
            ...
            <button className="Login-new-account-button"> Crea tu cuenta de Amazon </button>
