...
export const HeroCarousel = (props) => {
    ...
    const maxPage = Math.ceil(heroImagenes.length / imagesPerPage) - 1;
    ...
    return (
        ...
        <div className="Hero-carousel">
            ...
            <div className="Hero-carousel-h3">
                ...
                <HeroTitle {...heroTitles[Math.min(page, heroTitles.length-1)]} />
            ...
            <div className="Hero-carousel-wrapper" style={{
                width: ` calc( ${heroImagenes.length} * 100%)`,
                gridTemplateColumns: `repeat(${heroImagenes.length} , 15.625rem)`,
...
const HeroTitle = (props) => {
    ...
    const { _id, title, changeTitle } = props
    return (
        <h3> {title}</h3>
    )
}